...
module tb_rtl_crack();
    ...
    // ============== Memory helper tasks =============
    // rtl tb so we will use direct memory accesses through the rtl hierarchy
    ...
    initial begin
        ...
        // this makes sure the task5-added stepping logic is really working
