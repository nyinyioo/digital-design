...
module tb_rtl_task3();
    ...
    task read_pt_mem(input [7:0] mem_addr, output [7:0] mem_data);
        mem_data = DUT.pt.altsyncram_component.m_default.altsyncram_inst.mem_data[mem_addr];
    endtask
    ...
    task load_ct_mem;
        ...
        begin
            ...
            #10;
            for (i = 0; i < 256; i = i + 1)
                DUT.ct.altsyncram_component.m_default.altsyncram_inst.mem_data[i] = ct_data[i];
        end
    endtask
